...
export async function getStaticProps() {
  ...
  //education related campaigns
  const getSocialCausesCampaigns =
    contract.filters.campaignCreated("Social Causes");
  const SocialCausesCampaigns = await contract.queryFilter(
    getSocialCausesCampaigns
  );
  const SocialCausesData = SocialCausesCampaigns.map((e) => {
    return {
      title: e.args.title,
      image: e.args.imgURI,
      owner: e.args.owner,
  ...
  //FInance related campaigns
  const getFinanceCampaigns = contract.filters.campaignCreated("Finance");
  const FinanceCampaigns = await contract.queryFilter(getFinanceCampaigns);
  const FinanceData = FinanceCampaigns.map((e) => {
    return {
      title: e.args.title,
      image: e.args.imgURI,
      owner: e.args.owner,
  ...
  //science technology related campaigns
  const getScienceCampaigns = contract.filters.campaignCreated("Science");
  const ScienceCampaigns = await contract.queryFilter(getFinanceCampaigns);
  const ScienceData = ScienceCampaigns.map((e) => {
    return {
      title: e.args.title,
      image: e.args.imgURI,
      owner: e.args.owner,
  ...
  //enviroment related campaings
  const getEnvironmentCampaigns =
    contract.filters.campaignCreated("Environment");
  const EnvironmentCampaigns = await contract.queryFilter(
    getEnvironmentCampaigns
  );
  ...
  // Art reated campaigns
  const getArtsCampaigns = contract.filters.campaignCreated("Arts");
  const ArtsCampaigns = await contract.queryFilter(getArtsCampaigns);
  const ArtsData = ArtsCampaigns.map((e) => {
    return {
      title: e.args.title,
      image: e.args.imgURI,
      owner: e.args.owner,
  ...
  //animals Related campaigns
  const getAnimalCampaigns = contract.filters.campaignCreated("Animal");
